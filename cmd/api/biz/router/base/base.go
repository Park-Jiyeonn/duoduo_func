...
import (
	...
	base "simple_tiktok/cmd/api/biz/handler/base"
)
...
func Register(r *server.Hertz) {
	...
	root := r.Group("/", rootMw()...)
	{
		_douyin := root.Group("/douyin", _douyinMw()...)
		{
			...
			_feed.GET("/", append(_getvideolistMw(), base.GetVideoList)...)
		}
		{
			...
			}
			{
				...
				_list.GET("/", append(_getpublishlistMw(), base.GetPublishList)...)
			}
		}
		{
			_user := _douyin.Group("/user", _userMw()...)
			_user.GET("/", append(_getuserinfoMw(), base.GetUserInfo)...)
			{
